...
final class DotenvDumpCommand extends Command
{
    ...
    protected function configure()
    {
        $this->setDefinition([
            new InputArgument(
                "env",
                null === $this->defaultEnv
                    ? InputArgument::REQUIRED
                    : InputArgument::OPTIONAL,
                'The application environment to dump .env files for - e.g. "prod".'
            ),
        ])
            ->addOption(
                "empty",
                ...
                "Ignore the content of .env files"
            )
            ->setHelp(
                <<<'EOT'
...
EOF;
        ...
        $output->writeln(
            sprintf(
                "Successfully dumped .env files in <info>.env.local.php</> for the <info>%s</> environment.",
                $env
            )
        );
